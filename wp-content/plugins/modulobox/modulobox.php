 ...
 * @link      https://codecanyon.net/user/theme-one/
	...
	class ModuloBox {
		...
		public function includes() {
			...
			if ( is_admin() ) {
				...
				require_once( MOBX_INCLUDES_PATH . 'plugin-info.class.php' );
				require_once( MOBX_INCLUDES_PATH . 'plugin-update.class.php' );
