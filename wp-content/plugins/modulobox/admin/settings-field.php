	...
	function modulobox_register_settings_field( $API ) {
		...
		$API->add_settings_field( 'gallery', array(
			...
			array(
				'ID'           => 'galleryShortcode',
				'type'         => 'checkbox',
				'title'        => __( 'Enable Gallery Shortcode', 'modulobox' ),
				'description'  => __( 'When enabled, ModuloBox will replace all WordPress Gallery shortcode by it\'s own custom shortcode.', 'modulobox' )
			),
