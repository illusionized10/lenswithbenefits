...
class ModuloBox_Admin_Init {
	...
	public function localize() {
		...
		return array(
			...
			'registering_msg' => esc_html__( 'Please wait, registering ModuloBox...' , 'modulobox' ),
			'checking_msg'    => esc_html__( 'Please wait, checking for update...' , 'modulobox' ),
			'updating_msg'    => esc_html__( 'Please wait, updating ModuloBox...' , 'modulobox' ),
			...
			'svg_icons'       => esc_url( MOBX_PUBLIC_URL . 'assets/icons/modulobox.svg' ),
			...
			'lightbox_media'  => array(
				...
				array(
					'src'    => esc_url( 'https://vimeo.com/147865858' ),
					'poster' => esc_url( MOBX_ADMIN_URL . 'assets/images/image-4.jpg' ),
	...
	public function enqueue_scripts() {
		...
		if ( strpos( $screen->id, MOBX_NAME ) !== false ) {
			...
			// enqueue main script
			wp_enqueue_script( MOBX_NAME . '-options', MOBX_ADMIN_URL . 'assets/js/options.js', array( 'jquery' ), MOBX_VERSION, true) ;
			// localize strings
